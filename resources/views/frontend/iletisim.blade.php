    ...
    <form method="post" action="{{route('contact-post')}}">
      ...
      <div class="control-group">
        <div class="form-group  controls">
          ...
          <input type="text" class="form-control" value="{{old('name')}}" placeholder="Ad Soyadınız" name="name"  >
      ...
      <div class="control-group">
        <div class="form-group  controls">
          ...
          <input type="email" class="form-control" value="{{old('email')}}" placeholder="Email Addresiniz" name="email" >
        </div>
      </div>
      <div class="control-group">
