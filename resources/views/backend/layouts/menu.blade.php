    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse  @if(Request::segment(2)=='makaleler') show  @endif " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item   @if(Request::segment(2)=='makaleler' and !Request::segment(3)) active  @endif"  href="{{route('makaleler.index')}}">Makaleler</a>
        ...
        <li class="nav-item">
            <a class="nav-link "  @if(Request::segment(2)=='kategoriler') style="color:white !important" @endif href="{{route('categories')}}">
                <i   @if(Request::segment(2)=='kategoriler') style="color:white !important" @endif  class="fas fa-list  "></i>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePage" class="collapse  @if(Request::segment(2)=='sayfalar') show  @endif " aria-labelledby="headingPage" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item  @if(Request::segment(2)=='sayfalar' and Request::segment(3)=='create') active  @endif" href="{{route('pages.create')}}">Sayfa Oluştur</a>
                </div>
            </div>
        </li>
